    ...
    <div class="container py-5">
        <div class="card p-5" style="max-width: 800px; margin: 0 auto;">
            <div class="mb-4 text-center">
                <h2 style="color: var(--primary-color);">Tambah Barang Baru</h2>
                <p style="color: #6b7280;">Masukkan informasi peralatan camping baru</p>
            </div>
                ...
                <div class="grid mb-4" style="grid-template-columns: 1fr 1fr; gap: 1rem;">
                    <div class="form-group">
                        ...
                        <select name="kategori" class="form-control" required>
                            ...
                            <option value="Peralatan Masak" {{ old('kategori') == 'Peralatan Masak' ? 'selected' : '' }}>
                                Peralatan Masak</option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="kondisi" class="form-control" required>
                            ...
                            <option value="Perlu Perawatan" {{ old('kondisi') == 'Perlu Perawatan' ? 'selected' : '' }}>Perlu
                                Perawatan</option>
                        </select>
                    </div>
                </div>
